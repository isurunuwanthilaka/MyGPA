...
public class SemesterFourActivity extends AppCompatActivity {

    public static final int NEW_MODULE_ACTIVITY_REQUEST_CODE = 1;
    public static final int SEMESTER_NO = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mModuleViewModel.getSemFourModules().observe(this, new Observer<List<ModuleEntity>>() {
            @Override
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SemesterFourActivity.this, NewModuleActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_info) {
            Toast.makeText(this, "Minimum GPA Credits : 19.0\nMinimum Non-GPA Credits : 2.0", Toast.LENGTH_LONG).show();
